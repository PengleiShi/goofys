...
replace (
	github.com/Azure/azure-sdk-for-go v44.1.0+incompatible => github.com/Azure/azure-sdk-for-go v32.1.0+incompatible
	github.com/jacobsa/fuse v0.0.0-20200706075950-f8927095af03 => github.com/kahing/fusego v0.0.0-20200327063725-ca77844c7bcc
